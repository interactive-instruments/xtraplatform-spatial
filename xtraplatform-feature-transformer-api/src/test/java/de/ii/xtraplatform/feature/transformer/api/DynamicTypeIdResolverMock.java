    ...
    public static HandlerInstantiator handlerInstantiator() {
        return new HandlerInstantiator() {
            ...
            public TypeIdResolver typeIdResolverInstance(MapperConfig<?> config, Annotated annotated, Class<?> resolverClass) {
                return new DynamicTypeIdResolverMock(null/*TODO new GeoJsonTargetMappingSubTypeIds(), new GenericMappingSubTypeIds(), new MicrodataMappingSubTypeIds(), new JsonLdMappingSubTypeIds()*/);
            }
        };
    }
