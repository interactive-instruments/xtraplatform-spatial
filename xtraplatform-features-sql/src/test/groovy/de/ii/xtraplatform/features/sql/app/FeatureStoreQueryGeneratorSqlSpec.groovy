...
class FeatureStoreQueryGeneratorSqlSpec extends Specification {
    ...
    def 'Floors greater than 5'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.FLOORS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_1_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.FLOORS, Optional.of(CqlFilterExamples.EXAMPLE_1_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Taxes less than or equal to 500'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.TAXES, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_2_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.TAXES, Optional.of(CqlFilterExamples.EXAMPLE_2_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name contains "Jones"'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_3_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_3_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name starts with "Mike"'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_4_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_4_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name does not contain "Mike"'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_5_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_5_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'A swimming pool'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SWIMMING_POOL, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_6_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SWIMMING_POOL, Optional.of(CqlFilterExamples.EXAMPLE_6_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'More than 5 floors and a swimming pool'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_7_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_7_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'A swimming pool and (more than five floors or material is brick)'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_8_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_8_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def '[More than five floors and material is brick] or swimming pool is true'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_9_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_9_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Not under 5 floors or a swimming pool'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_10_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_10_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name starts with "mike" or "Mike" and is less than 4 floors'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_11_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_11_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Built before 2015'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.BUILT, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_12_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.BUILT, Optional.of(CqlFilterExamples.EXAMPLE_12_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Built after June 5, 2012'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.BUILT, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_13_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.BUILT, Optional.of(CqlFilterExamples.EXAMPLE_13_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
        metaQuery == "SELECT * FROM (SELECT MIN(SKEY) AS minKey, MAX(SKEY) AS maxKey, count(*) AS numberReturned FROM (SELECT A.id AS SKEY FROM container A WHERE A.id IN (SELECT AA.id FROM container AA  WHERE AA.built > TIMESTAMP '2012-06-05T00:00:00Z') ORDER BY SKEY LIMIT 10) AS NR) AS NR2, (SELECT count(*) AS numberMatched FROM (SELECT A.id AS SKEY FROM container A WHERE A.id IN (SELECT AA.id FROM container AA  WHERE AA.built > TIMESTAMP '2012-06-05T00:00:00Z') ORDER BY 1) AS NM) AS NM2"
        instanceQuery == "SELECT A.id AS SKEY, A.built FROM container A WHERE (A.id >= NULL AND A.id <= NULL) AND (A.id IN (SELECT AA.id FROM container AA  WHERE AA.built > TIMESTAMP '2012-06-05T00:00:00Z')) ORDER BY 1"
    }
    ...
    def 'Updated between 7:30am June 10, 2017 and 10:30am June 11, 2017'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.UPDATED, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_14_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.UPDATED, Optional.of(CqlFilterExamples.EXAMPLE_14_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Location in the box between -118,33.8 and -117.9,34 in long/lat (geometry 1)'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.LOCATION, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_15_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.LOCATION, Optional.of(CqlFilterExamples.EXAMPLE_15_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Location that intersects with geometry'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.LOCATION, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_16_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.LOCATION, Optional.of(CqlFilterExamples.EXAMPLE_16_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
        metaQuery == "SELECT * FROM (SELECT MIN(SKEY) AS minKey, MAX(SKEY) AS maxKey, count(*) AS numberReturned FROM (SELECT A.id AS SKEY FROM container A WHERE A.id IN (SELECT AA.id FROM container AA  WHERE ST_3DIntersects(AA.location, ST_GeomFromText('POLYGON((-10.0 -10.0,10.0 -10.0,10.0 10.0,-10.0 -10.0))',4326))) ORDER BY SKEY LIMIT 10) AS NR) AS NR2, (SELECT count(*) AS numberMatched FROM (SELECT A.id AS SKEY FROM container A WHERE A.id IN (SELECT AA.id FROM container AA  WHERE ST_Intersects(AA.location, ST_GeomFromText('POLYGON((-10.0 -10.0,10.0 -10.0,10.0 10.0,-10.0 -10.0))',4326))) ORDER BY 1) AS NM) AS NM2"
        instanceQuery == "SELECT A.id AS SKEY, A.location FROM container A WHERE (A.id >= NULL AND A.id <= NULL) AND (A.id IN (SELECT AA.id FROM container AA  WHERE ST_3DIntersects(AA.location, ST_GeomFromText('POLYGON((-10.0 -10.0,10.0 -10.0,10.0 10.0,-10.0 -10.0))',4326)))) ORDER BY 1"
    }

    def 'More than 5 floors and is within geometry 1 (below)'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_17_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_17_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Number of floors between 4 and 8'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.FLOORS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_18_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.FLOORS, Optional.of(CqlFilterExamples.EXAMPLE_18_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name is either Mike, John or Tom'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_19_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_19_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'owner is null'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_20_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_20_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'owner is not null'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_21_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_21_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Built before 2015 (only date, no time information)'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.BUILT, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_24_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.BUILT, Optional.of(CqlFilterExamples.EXAMPLE_24_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Updated between June 10, 2017 and June 11, 2017'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.UPDATED, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_25_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.UPDATED, Optional.of(CqlFilterExamples.EXAMPLE_25_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Updated between 7:30am June 10, 2017 and open end date'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.UPDATED, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_26_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.UPDATED, Optional.of(CqlFilterExamples.EXAMPLE_26_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Updated between open start date and 10:30am June 11, 2017'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.UPDATED, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_27_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.UPDATED, Optional.of(CqlFilterExamples.EXAMPLE_27_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Open interval on both ends'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.UPDATED, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_28_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.UPDATED, Optional.of(CqlFilterExamples.EXAMPLE_28_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Function with no arguments'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.LOCATION, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_29_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.LOCATION, Optional.of(CqlFilterExamples.EXAMPLE_29_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Function with multiple arguments'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.NAMES, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_30_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.NAMES, Optional.of(CqlFilterExamples.EXAMPLE_30_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Function with a temporal argument'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.BUILT, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_31_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.BUILT, Optional.of(CqlFilterExamples.EXAMPLE_31_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Property with a nested filter'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.MEASURE, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_32_OLD), Collections.emptyList(), true)
        List<String> instanceQueries = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.MEASURE, Optional.of(CqlFilterExamples.EXAMPLE_32_OLD), Collections.emptyList(), 1, 10, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList())
        then:
    ...
    def 'Property with a nested filter on parent table'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.MEASURE_CLASSIFICATION, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_41_OLD), Collections.emptyList(), true)
        List<String> instanceQueries = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.MEASURE_CLASSIFICATION, Optional.of(CqlFilterExamples.EXAMPLE_41_OLD), Collections.emptyList(), 1, 10, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList())
        then:
    ...
    def 'Find the Landsat scene with identifier "LC82030282019133LGN00"'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCENE_ID, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_34_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCENE_ID, Optional.of(CqlFilterExamples.EXAMPLE_34_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Both operands are property references'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.SCALAR_OPERATIONS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_37_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.SCALAR_OPERATIONS, Optional.of(CqlFilterExamples.EXAMPLE_37_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Number of floors NOT between 4 and 8'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.FLOORS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_39_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.FLOORS, Optional.of(CqlFilterExamples.EXAMPLE_39_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Owner name is NOT Mike, John, Tom'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.OWNER, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_40_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.OWNER, Optional.of(CqlFilterExamples.EXAMPLE_40_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Property with a nested filter with a function'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.MEASURE, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_NESTED_FUNCTION_OLD), Collections.emptyList(), true)
        List<String> instanceQueries = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.MEASURE, Optional.of(CqlFilterExamples.EXAMPLE_NESTED_FUNCTION_OLD), Collections.emptyList(), 1, 10, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList())
        then:
    ...
    def 'Case insensitive string comparison function CASEI'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.ROAD_CLASS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_CASEI_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.ROAD_CLASS, Optional.of(CqlFilterExamples.EXAMPLE_CASEI_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
    ...
    def 'Accent insensitive string comparison function ACCENTI'() {
        when:
        String metaQuery = queryGeneratorSql.getMetaQuery(FeatureStoreFixtures.ROAD_CLASS, 10, 0, Optional.of(CqlFilterExamples.EXAMPLE_ACCENTI_OLD), Collections.emptyList(), true)
        String instanceQuery = queryGeneratorSql.getInstanceQueries(FeatureStoreFixtures.ROAD_CLASS, Optional.of(CqlFilterExamples.EXAMPLE_ACCENTI_OLD), Collections.emptyList(), null, null, Collections.emptyList(), Collections.emptyList()).collect(Collectors.toList()).get(0)
        then:
