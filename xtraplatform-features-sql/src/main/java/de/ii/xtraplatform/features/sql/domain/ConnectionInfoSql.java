...
public interface ConnectionInfoSql extends ConnectionInfo {
    ...
    /**
     * @langEn The name of the database. For `GPKG` the file path, either absolute or relative to the [data folder](../application/30-data-folder.md).
     * @langDe Der Name der Datenbank. Für `GPKG` der Pfad zur Datei, entweder absolut oder relativ zum [Daten-Verzeichnis](../application/30-data-folder.md).
     */
    String getDatabase();
    ...
    interface PoolSettings {
         ...
         * processor cores and the maximum number of joins per feature type in the [Types Configuration](README.md#types).
         ...
         * der Prozessorkerne und der Anzahl der Joins in der [Types-Konfiguration](README.md#types).
