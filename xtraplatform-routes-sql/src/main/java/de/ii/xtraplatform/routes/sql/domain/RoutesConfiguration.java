...
/**
 * @langEn The routing extension requires that the feature provider includes a feature type that
 ...
 *     </code>
 * @langDe Die Routing-Erweiterung erfordert, dass der Feature Provider eine Objektart mit den
