...
public class CqlFilterExamples {
    ...
    public static final Cql2Predicate EXAMPLE_12_alt = Lt.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));
    public static final Cql2Predicate EXAMPLE_12eq_alt = Lte.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));
    ...
    public static final Cql2Predicate EXAMPLE_13_alt = Gt.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));
    public static final Cql2Predicate EXAMPLE_13eq_alt = Gte.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));

    public static final Cql2Predicate EXAMPLE_13A_alt = Eq.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));
    public static final Cql2Predicate EXAMPLE_13Aneq_alt = Neq.of(ImmutableList.of(Property.of("built"), TemporalLiteral.of("2012-06-05T00:00:00Z")));
    ...
    public static final Cql2Predicate EXAMPLE_15 = SWithin.of(Property.of("location"), SpatialLiteral.of(Geometry.Envelope.of(-118.0, 33.8, -117.9, 34.0, OgcCrs.CRS84)));
    ...
    public static final Cql2Predicate EXAMPLE_16 = SIntersects.of(Property.of("location"), SpatialLiteral.of(Geometry.Polygon.of(OgcCrs.CRS84, ImmutableList.of(
    ...
    public static final Cql2Predicate EXAMPLE_17 =And.of(
        EXAMPLE_1,
    ...
    public static final Cql2Predicate EXAMPLE_18 = Between.of(Property.of("floors"), ScalarLiteral.of(4), ScalarLiteral.of(8));
    ...
    public static final Cql2Predicate EXAMPLE_29 = Eq.ofFunction(
    ...
    public static final Cql2Predicate EXAMPLE_30 = Gte.ofFunction(
    ...
    public static final Cql2Predicate EXAMPLE_31 = Eq.ofFunction(
    ...
    public static final Cql2Predicate EXAMPLE_32 =
    ...
    public static final Cql2Predicate EXAMPLE_33 =
    ...
    public static final Cql2Predicate EXAMPLE_41 =
    ...
    public static final Cql2Predicate EXAMPLE_42 = Or.of(EXAMPLE_32, EXAMPLE_41);

    public static final Cql2Predicate EXAMPLE_34 = Eq.of("landsat:scene_id", ScalarLiteral.of("LC82030282019133LGN00"));
    ...
    public static final Cql2Predicate EXAMPLE_37 = Lt.of("height", "floors");
    public static final CqlFilter EXAMPLE_37_OLD = CqlFilter.of(Lt.of("height", "floors"));

    public static final Cql2Predicate EXAMPLE_38 = AContains.of(Property.of("layer:ids"), ArrayLiteral.of(ImmutableList.of(ScalarLiteral.of("layers-ca"), ScalarLiteral.of("layers-us"))));

    public static final Cql2Predicate EXAMPLE_39 = Not.of(Between.of("floors", ScalarLiteral.of(4), ScalarLiteral.of(8)));
    public static final CqlFilter EXAMPLE_39_OLD = CqlFilter.of(Not.of(Between.of("floors", ScalarLiteral.of(4), ScalarLiteral.of(8))));

    public static final Cql2Predicate EXAMPLE_40 = Not.of(In.of("owner", ScalarLiteral.of("Mike"), ScalarLiteral.of("John"), ScalarLiteral.of("Tom")));
    ...
    public static final Cql2Predicate EXAMPLE_IN_WITH_FUNCTION = In.ofFunction(
    ...
    public static final Cql2Predicate EXAMPLE_NESTED_FUNCTION =
    ...
    public static final Cql2Predicate EXAMPLE_NESTED_WITH_ARRAYS =
            AContains.of(
    ...
    public static final Cql2Predicate EXAMPLE_IN_WITH_TEMPORAL = In.of("updated",
    ...
    public static final Cql2Predicate EXAMPLE_TRUE = BooleanValue2.of(true);

    public static final Cql2Predicate EXAMPLE_BOOLEAN_VALUES = And.of(
        BooleanValue2.of(true),
        Or.of(
            BooleanValue2.of(false),
            Not.of(BooleanValue2.of(false))));

    public static final Cql2Predicate EXAMPLE_KEYWORD = Gt.of(ImmutableList.of(Property.of("root.date"), TemporalLiteral.of("2022-04-17")));

    public static final Cql2Predicate EXAMPLE_CASEI = In.ofFunction(
    ...
    public static final Cql2Predicate EXAMPLE_ACCENTI = In.ofFunction(
