...
public interface BinaryTemporalOperation extends BinaryOperation2<Temporal>, CqlNode {
    ...
    static BinaryTemporalOperation of(TemporalOperator operator, Temporal temporal1, Temporal temporal2) {
        switch (operator) {
            case T_AFTER:
    ...
    abstract class Builder<T extends BinaryTemporalOperation> extends Operation.Builder<Temporal, T> {}
