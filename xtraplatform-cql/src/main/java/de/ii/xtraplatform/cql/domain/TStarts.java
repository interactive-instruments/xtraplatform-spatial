...
@Value.Immutable
@JsonDeserialize(as = TStarts.class)
public interface TStarts extends TemporalOperation, CqlNode {

    abstract class Builder extends TemporalOperation.Builder<TStarts> {
    }
    ...
    default void check() {
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The first argument of T_STARTS must be a property or a time interval, found %s",
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The second argument of T_STARTS must be a property or a time interval, found %s",
