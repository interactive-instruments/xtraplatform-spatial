...
public interface TOverlaps extends TemporalOperation, CqlNode {
    ...
    default void check() {
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The first argument of T_OVERLAPS must be a property or a time interval, found %s",
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The second argument of T_OVERLAPS must be a property or a time interval, found %s",
