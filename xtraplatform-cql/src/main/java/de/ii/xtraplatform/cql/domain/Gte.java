...
public interface Gte extends BinaryScalarOperation, CqlNode {
    ...
    static Gte of(List<Scalar> operands) {
        return new ImmutableGte.Builder().args(operands)
                                        .build();
    }

    static Gte of(String property, ScalarLiteral scalarLiteral) {
        return new ImmutableGte.Builder().args(ImmutableList.of(Property.of(property),scalarLiteral))
                                        .build();
    }

    static Gte of(String property, String property2) {
        return new ImmutableGte.Builder().args(ImmutableList.of(Property.of(property), Property.of(property2)))
                                        .build();
    }

    static Gte of(Property property, ScalarLiteral scalarLiteral) {
        return new ImmutableGte.Builder().args(ImmutableList.of(property,scalarLiteral))
                                        .build();
    }

    static Gte of(Property property, Property property2) {
        return new ImmutableGte.Builder().args(ImmutableList.of(property, property2))
                                        .build();
    }

    static Gte ofFunction(Function function, ScalarLiteral scalarLiteral) {
        return new ImmutableGte.Builder().args(ImmutableList.of(function, scalarLiteral))
                                        .build();
    }
