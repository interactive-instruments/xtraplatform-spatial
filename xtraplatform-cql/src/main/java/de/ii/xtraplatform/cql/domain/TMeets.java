...
public interface TMeets extends TemporalOperation, CqlNode {

    abstract class Builder extends TemporalOperation.Builder<TMeets> {
    }
    ...
    default void check() {
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The first argument of T_MEETS must be a property or a time interval, found %s",
        ...
        Preconditions.checkState( getOperands().get(0) instanceof Property ||
                ...
                "The second argument of T_MEETS must be a property or a time interval, found %s",
