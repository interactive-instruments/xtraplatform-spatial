 ...
 * @langEn # Common
 * <p>
 * Codelists allow to map property values to a different value. This is useful especially for HTML
 * representations.
 * @langDe # Allgemein
 * <p>
 * Codelisten können zum Übersetzen von Eigenschaftswerten in einen anderen Wert genutzt werden,
 * meist für die HTML-Ausgabe.
 ...
 * @langDe ### Beispiel
 * <p>
 * Basierend auf der INSPIRE-Codelist
 * [EnvironmentalDomain](https://inspire.ec.europa.eu/codeList/EnvironmentalDomain) werden Werte wie
 * `soil` auf das deutschsprachige Label in der INSPIRE-Codelist-Registry abgebildet:
 * @langAll <code>
 * ```yaml
 * ---
 ...
 * @langEn ## Storage
 * <p>
 * Codelists reside under the relative path `store/entities/codelists/{codelistId}.yml` in the data
 * directory.
 * @langDe ## Speicherung
 * <p>
 * Die Codelisten liegen als YAML-Dateien im ldproxy-Datenverzeichnis unter dem relativen Pfad
 * `store/entities/codelists/{codelistId}.yml`.
 * @propertyTable {@link de.ii.xtraplatform.codelists.domain.ImmutableCodelistData}
 */
@DocFile(path = "codelists", name = "README.md", tables = {
    @DocTable(
        name = "properties",
        rows = {
