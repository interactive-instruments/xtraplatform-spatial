...
public class StreamingGMLParserTest {
    ...
    public void testParser() throws Exception {
        ...
        final Flow<ByteString, GmlEvent, NotUsed> parser = StreamingGMLParser.parser(new QName("http://www.adv-online.de/namespaces/adv/gid/6.0", "AX_Bahnstrecke"));

        final Sink<String, CompletionStage<List<GmlEvent>>> parse = Flow.<String>create()
