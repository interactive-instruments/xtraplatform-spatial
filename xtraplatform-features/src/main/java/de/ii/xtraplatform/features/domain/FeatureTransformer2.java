...
public interface FeatureTransformer2 {
  ...
  void onPropertyStart(final FeatureProperty property, List<Integer> multiplicities)
      throws Exception;
  ...
  void onGeometryStart(
      final FeatureProperty property, final SimpleFeatureGeometry type, final Integer dimension)
      throws Exception;
