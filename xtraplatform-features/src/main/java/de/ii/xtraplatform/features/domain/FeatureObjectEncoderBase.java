...
public abstract class FeatureObjectEncoderBase<T extends SchemaBase<T>, U extends SchemaMappingBase<T>, V extends PropertyBase<V, T>, W extends FeatureBase<V, T>> extends
    FeatureTokenEncoderBase<T, U, ModifiableContext<T,U>> {
